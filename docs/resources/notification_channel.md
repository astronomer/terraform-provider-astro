...
subcategory: ""
description: |-
  Manage a single notification channel.
  ~> Deprecated Use the astro_notification_channels resource instead, which manages one or many notification channels in a single resource. Do not manage the same channel with both astro_notification_channel and astro_notification_channels — they conflict on every apply.
---
