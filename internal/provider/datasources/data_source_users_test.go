...
func TestAcc_DataSourceUsers(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + users(tfVarName),
				Check: resource.ComposeTestCheckFunc(
					checkUsers(tfVarName, false, false),
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + usersFilterWorkspaceId(tfVarName, tfWorkspaceId),
				Check: resource.ComposeTestCheckFunc(
					checkUsers(tfVarName, true, false),
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + usersFilterDeploymentId(tfVarName, tfDeploymentId),
				Check: resource.ComposeTestCheckFunc(
