		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(resourceVar, "rules"),
					...
					resource.TestCheckResourceAttrSet(resourceVar, "rules.pattern_matches.0.values"),
					...
					resource.TestCheckResourceAttrSet(resourceVar, "rules.pattern_matches.1.values"),
