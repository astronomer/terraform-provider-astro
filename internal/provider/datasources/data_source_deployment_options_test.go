...
func TestAcc_DataSourceDeploymentOptionsHosted(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + deploymentOptions(resourceName, ""),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + deploymentOptions(resourceName, `deployment_type = "STANDARD"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + deploymentOptions(resourceName, `deployment_type = "DEDICATED"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + deploymentOptions(resourceName, `executor = "CELERY"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + deploymentOptions(resourceName, `executor = "KUBERNETES"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + deploymentOptions(resourceName, `cloud_provider = "AWS"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + deploymentOptions(resourceName, `cloud_provider = "GCP"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, true, false) + deploymentOptions(resourceName, `cloud_provider = "AZURE"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
...
func TestAcc_DataSourceDeploymentOptionsHybrid(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: astronomerprovider.ProviderConfig(t, false, false) + deploymentOptions(resourceName, ""),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, false, false) + deploymentOptions(resourceName, `deployment_type = "HYBRID"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, false, false) + deploymentOptions(resourceName, `executor = "CELERY"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, false, false) + deploymentOptions(resourceName, `executor = "KUBERNETES"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, false, false) + deploymentOptions(resourceName, `cloud_provider = "AWS"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, false, false) + deploymentOptions(resourceName, `cloud_provider = "GCP"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
			{
				Config: astronomerprovider.ProviderConfig(t, false, false) + deploymentOptions(resourceName, `cloud_provider = "AZURE"`),
				Check: resource.ComposeTestCheckFunc(
					CheckDeploymentOptions(resourceVar)...,
				),
			},
