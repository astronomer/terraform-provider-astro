		...
		Steps: []resource.TestStep{
			...
			// Create: DAG_DURATION alert
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceVar, "entity_id", deploymentId),
					resource.TestCheckResourceAttr(resourceVar, "entity_type", string(platform.CreateDagDurationAlertRequestEntityTypeDEPLOYMENT)),
					resource.TestCheckResourceAttr(resourceVar, "notification_channel_ids.#", "1"),
					resource.TestCheckResourceAttr(resourceVar, "notification_channel_ids.0", notificationChannelId),
					resource.TestCheckResourceAttr(resourceVar, "rules.properties.deployment_id", deploymentId),
		...
		Steps: []resource.TestStep{
			...
			// Create: DAG_TIMELINESS alert
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceVar, "entity_id", deploymentId),
					resource.TestCheckResourceAttr(resourceVar, "entity_type", string(platform.CreateDagTimelinessAlertRequestEntityTypeDEPLOYMENT)),
					resource.TestCheckResourceAttr(resourceVar, "notification_channel_ids.#", "1"),
					resource.TestCheckResourceAttr(resourceVar, "notification_channel_ids.0", notificationChannelId),
					resource.TestCheckResourceAttr(resourceVar, "rules.properties.deployment_id", deploymentId),
		...
		Steps: []resource.TestStep{
			...
			// Create: TASK_DURATION alert
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceVar, "entity_id", deploymentId),
					resource.TestCheckResourceAttr(resourceVar, "entity_type", string(platform.CreateTaskDurationAlertRequestEntityTypeDEPLOYMENT)),
					resource.TestCheckResourceAttr(resourceVar, "notification_channel_ids.#", "1"),
					resource.TestCheckResourceAttr(resourceVar, "notification_channel_ids.0", notificationChannelId),
					resource.TestCheckResourceAttr(resourceVar, "rules.properties.deployment_id", deploymentId),
